...
SOURCES = \
	__init__.py \
	metsa_mask.py metsa_mask_dialog.py

PLUGINNAME = metsa_mask

PY_FILES = \
	__init__.py \
	metsa_mask.py metsa_mask_dialog.py

UI_FILES = metsa_mask_dialog_base.ui
...
QGISDIR=C:\Users\asims.EMU\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
